...
当前扩展版本为 **1.0.0 提审候选版**，可通过加载已解压扩展使用。商店素材和提审准备状态见 [store-assets](./store-assets/README.md)。
...
- **外观设置**：浅色、深色、跟随系统；预设或上传壁纸、渐变背景、布局和透明度调节。
...
也可以解压本地生成的 `leafmark-v1.0.0.zip`，再加载解压后的目录。更新构建后，在扩展管理页刷新扩展。
